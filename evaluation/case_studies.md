...
**reduced feeding (≤15%)** [+2] → severity 3 → critical.
...
**Why flagged suspect**
Only the **low body-condition rule** fires (BCS ≤ 2.2, +1) → suspect.
...
|---|---|---|---|---|---|---|---|
| C11 | 🔴 critical | 64% | 14% | 2.69 | — | — | excessive lying + reduced feeding |
...
**Take-away for the report:** the three flagged cows are flagged for three *different* reasons
(behaviour, physiology, condition), which demonstrates the value of combining modalities — no
single signal would have caught all three.
